...
useragent = "Linux; Android 6.0.1; SM-G920V Build/MMB29K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36"
...
REVERSE_HANDLER = DisableAbleCommandHandler(
    ["reverse", "p", "P", "pp","PP", "Pp"], reverse, pass_args=True, admin_ok=True, run_async=True
)
